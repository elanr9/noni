// Admin handoff §8 — the camera roll sheet for screenshot slots: 3-up
// grid of 124px tiles with date badges, selection is a 2.5px blue-500
// outline with a blue check. Falls back to the system picker when photo
// access is denied.
...
export function CameraRollSheet({ visible, onClose, onPick }: CameraRollSheetProps) {
  ...
  return (
    <Sheet
      ...
      footer={
        denied ? undefined : (
          <Button block disabled={selectedId === null || confirming} onPress={() => void confirm()}>
